...
module.exports = {
  content: [
    "./app.vue",
    "./pages/**/*.{vue,js,ts}", // Important: Include your template files
  ],
  theme: {
    extend: {
      colors: {
        primary: { // Define your primary color palette
          50: '#f0f9ff',
          100: '#e0f2ff',
          200: '#c7e5ff',
          300: '#aed8ff',
        ...
        secondary: { // Define your secondary color palette
          50: '#f3e8ff',
          100: '#e7d5ff',
          200: '#d1bfff',
          300: '#ba9dff',
        ...
        accent: { // Define an accent color if needed
          50: '#fff0cc',
          100: '#ffe8ad',
          200: '#ffe08b',
          300: '#ffd869',
      ...
      fontFamily: { // Define your preferred font families
      ...
      fontSize: { // Customize font sizes if needed
        '2xs': '0.625rem',
